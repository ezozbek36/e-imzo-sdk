...
|----------|---------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| RFC-0001 | editorial three-plane partition, actor map, trust boundaries, canonical term usage, boundary between local/server/mobile framing            | editorial, cross-RFC consistency, version-drift review     | `docs/phases/phase-1/canonical.md`, `docs/inventories/glossary.md`, `docs/rfc/RFC-0001-terminology-and-architecture.md`                   | `challenge` vs `challange`, mobile actor split, incomplete local-vs-server responsibility split                                 | Build a source-backed terminology and boundary conflict matrix with explicit version notes                                  |
...
| field-variant examples                  | examples showing `challenge`/`challange`, `pkcs7b64`/`pkcs7_64`, and handle-field variants in context                                              | Needed to validate whether terms are aliases, drift, or distinct fields                          | Drift is documented, but side-by-side preserved examples are not yet assembled                     |
...
- [CONFLICT] The repository still contains unresolved field drift around `challenge` vs `challange` and `pkcs7b64` vs `pkcs7_64`.
