...
| `Q-002` | pkcs7b64 vs pkcs7_64 equivalence                   | `resolved-editorially` | ezozbek36  | [Q-002 note](../research/open-questions/Q-002-pkcs7b64-vs-pkcs7_64.md)                   | Use editorial `PKCS#7 base64 payload` for the shared concept, but preserve literal `pkcs7_64` and `pkcs7b64` in concrete payloads and examples. | [Glossary](../inventories/glossary.md), [Entity Inventory](../inventories/entities.md), [RFC-0001](../rfc/RFC-0001-terminology-and-architecture.md), [RFC-0002](../rfc/RFC-0002-local-bridge.md), [RFC-0003](../rfc/RFC-0003-signing-and-authentication-flows.md) |
