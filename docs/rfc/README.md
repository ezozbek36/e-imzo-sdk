...
- `[OBSERVED]` — direct evidence from repository sources
- `[NORMALIZED]` — controlled terminology normalization
- `[OPEN QUESTION]` — unresolved ambiguity or conflict
- `[PROPOSED ABSTRACTION]` — tentative future-facing structure, not source truth
