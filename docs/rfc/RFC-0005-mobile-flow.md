...
| Tag        | Source                                                                                                      | Why used                                                                       |
|------------|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [OBSERVED] | `Phase1.md`                                                                                                 | Consolidated mobile entities and ambiguities.                                  |
| [OBSERVED] | `e-imzo-resources/e-imzo-doc/README.md`                                                                     | Mobile endpoint descriptions, status code tables, sequence diagrams.           |
| [OBSERVED] | `e-imzo-resources/e-imzo-doc/example.uz/php/demo/eimzoidcard/index.html`, `js/e-imzo-mobile.js`             | Polling logic, deeplink/QR payload assembly, app redirect/finalization wiring. |
| [OBSERVED] | `e-imzo-resources/e-imzo-doc/example.uz/php/demo/eimzoidcard/user_auth_result.php`, `doc_verify_result.php` | Backend finalize call examples.                                                |
| [OBSERVED] | `e-imzo-resources/knowledge-base/integration-faq.md`                                                        | Onboarding and upload URL operational constraints.                             |
